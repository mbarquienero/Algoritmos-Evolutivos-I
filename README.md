...
Para reflejar criterios del dominio (seguridad y coherencia técnica) se usaron **restricciones suaves** en la función de aptitud: bonificaciones por ítems críticos (agua, comida, cuerda, botiquín, navegación), penalizaciones por faltantes, dependencias mínimas y penal por **sobrepeso**.
